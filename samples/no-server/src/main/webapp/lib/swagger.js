...
// modified for intuit
  SwaggerResource.prototype.getAbsoluteBasePath = function (apiPath) {
    var documentationUrl = this.api.basePath;
    ...
    if (apiPath.substring(0, 1) == "/") {
      ...
      if (apiPath.charAt(apiPath.length - 1) == "/")
        var normalizedApiPath = apiPath.substring(0, apiPath.length - 1);
      else 
...
// end modification
  ...
  SwaggerResource.prototype.addApiDeclaration = function (response) {
    ...
    if (response.basePath != null)
      this.basePath = this.getAbsoluteBasePath(response.basePath);
