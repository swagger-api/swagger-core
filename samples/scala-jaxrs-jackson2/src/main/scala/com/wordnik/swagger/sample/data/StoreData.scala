...
object StoreData {
  ...
  orders ++= List(Order(1, 1, 2, new Date(), "placed"),
    Order(2, 1, 2, new Date(), "delivered"),
    Order(3, 2, 2, new Date(), "placed"),
    Order(4, 2, 2, new Date(), "delivered"),
    Order(5, 3, 2, new Date(), "placed"))
