---
layout: default
title: Swagger RESTful API Documentation Specification
selectedMenu: spec
---
...
1. [**The Resource Listing**](#toc_16) - This is the root document that contains general API information and lists the resources. Each resource has its own URL that defines the API operations on it.
