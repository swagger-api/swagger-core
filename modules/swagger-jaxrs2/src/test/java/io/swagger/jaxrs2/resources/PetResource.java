...
import io.swagger.jaxrs2.resources.data.PetData;
...
public class PetResource {
    ...
    public Response getPetById(
            ...
            @PathParam("petId") Long petId) throws io.swagger.jaxrs2.resources.exception.NotFoundException {
        Pet pet = petData.getPetById(petId);
        if (null != pet) {
            return Response.ok().entity(pet).build();
        } else {
            throw new io.swagger.jaxrs2.resources.exception.NotFoundException(404, "Pet not found");
        }
    }
