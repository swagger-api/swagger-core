...
import io.swagger.v3.jaxrs2.resources.ResponseEmptySchemaResource.ResponseEmptySchemaJsonResource;
...
public class ReaderTest {
    ...
    @Test(description = "Response with empty schema (Json content type)")
    public void testGetJsonResponseWithEmptySchema() {
        Reader reader = new Reader(new OpenAPI());

        OpenAPI openAPI = reader.read(ResponseEmptySchemaJsonResource.class);
        String yaml = "openapi: 3.0.1\n"
                + "paths:\n"
                + "  /noContentResource/default:\n"
                + "    get:\n"
