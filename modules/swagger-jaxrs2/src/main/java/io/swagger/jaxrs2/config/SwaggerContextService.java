...
public class SwaggerContextService {
    ...
    public SwaggerContextService initConfig(OpenAPI openAPI) {
        ...
        if (openAPI != null) {
            SwaggerConfigLocator.getInstance().putSwagger(configIdKey, openAPI);
        }
        return this;
    ...
    public OpenAPI getSwagger() {
        OpenAPI value = (OpenAPI) getConfigOrSwagger(true);
        if (value == null && isServletConfigAvailable(sc)) {
            value = (OpenAPI) sc.getServletContext().getAttribute("swagger");
        }
        if (value == null) value = new OpenAPI();
        return value;
    }

    public SwaggerContextService updateSwagger(OpenAPI openAPI) {
