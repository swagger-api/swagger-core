...
import io.swagger.v3.jakartarest.annotations.AbstractAnnotationTest;
import io.swagger.v3.jakartarest.matchers.SerializationMatchers;
import io.swagger.v3.jakartarest.petstore.EmptyPetResource;
import io.swagger.v3.jakartarest.petstore.WebHookResource;
import io.swagger.v3.jakartarest.petstore.callback.ComplexCallback31Resource;
import io.swagger.v3.jakartarest.petstore.callback.ComplexCallbackResource;
import io.swagger.v3.jakartarest.petstore.callback.MultipleCallbacksTestWithOperationResource;
import io.swagger.v3.jakartarest.petstore.callback.RepeatableCallbackResource;
import io.swagger.v3.jakartarest.petstore.callback.SimpleCallbackWithOperationResource;
import io.swagger.v3.jakartarest.petstore.example.ExamplesResource;
import io.swagger.v3.jakartarest.petstore.link.LinksAndContent31Resource;
import io.swagger.v3.jakartarest.petstore.link.LinksResource;
import io.swagger.v3.jakartarest.petstore.openapidefintion.OpenAPI31DefinitionResource;
import io.swagger.v3.jakartarest.petstore.openapidefintion.OpenAPIDefinitionResource;
import io.swagger.v3.jakartarest.petstore.operation.AnnotatedSameNameOperationResource;
import io.swagger.v3.jakartarest.petstore.operation.ExternalDocumentationResource;
import io.swagger.v3.jakartarest.petstore.operation.FullyAnnotatedOperationResource;
import io.swagger.v3.jakartarest.petstore.operation.HiddenOperationResource;
import io.swagger.v3.jakartarest.petstore.operation.NotAnnotatedSameNameOperationResource;
import io.swagger.v3.jakartarest.petstore.operation.OperationResource;
import io.swagger.v3.jakartarest.petstore.operation.OperationWithoutAnnotationResource;
import io.swagger.v3.jakartarest.petstore.operation.ServerOperationResource;
import io.swagger.v3.jakartarest.petstore.operation.SubResource;
import io.swagger.v3.jakartarest.petstore.parameter.ArraySchemaResource;
import io.swagger.v3.jakartarest.petstore.parameter.ComplexParameterResource;
import io.swagger.v3.jakartarest.petstore.parameter.ComplexParameterWithOperationResource;
import io.swagger.v3.jakartarest.petstore.parameter.MultipleNotAnnotatedParameter;
import io.swagger.v3.jakartarest.petstore.parameter.OpenAPIJaxRSAnnotatedParameter;
import io.swagger.v3.jakartarest.petstore.parameter.OpenAPIWithContentJaxRSAnnotatedParameter;
import io.swagger.v3.jakartarest.petstore.parameter.OpenAPIWithImplementationJaxRSAnnotatedParameter;
import io.swagger.v3.jakartarest.petstore.parameter.Parameters31Resource;
import io.swagger.v3.jakartarest.petstore.parameter.ParametersResource;
import io.swagger.v3.jakartarest.petstore.parameter.RepeatableParametersResource;
import io.swagger.v3.jakartarest.petstore.parameter.SingleJaxRSAnnotatedParameter;
import io.swagger.v3.jakartarest.petstore.parameter.SingleNotAnnotatedParameter;
import io.swagger.v3.jakartarest.petstore.requestbody.RequestBody31Resource;
import io.swagger.v3.jakartarest.petstore.requestbody.RequestBodyMethodPriorityResource;
import io.swagger.v3.jakartarest.petstore.requestbody.RequestBodyParameterPriorityResource;
import io.swagger.v3.jakartarest.petstore.requestbody.RequestBodyResource;
import io.swagger.v3.jakartarest.petstore.responses.*;
import io.swagger.v3.jakartarest.petstore.security.SecurityResource;
import io.swagger.v3.jakartarest.petstore.tags.CompleteTagResource;
import io.swagger.v3.jakartarest.petstore.tags.TagClassResource;
import io.swagger.v3.jakartarest.petstore.tags.TagMethodResource;
import io.swagger.v3.jakartarest.petstore.tags.TagOpenAPIDefinitionResource;
import io.swagger.v3.jakartarest.petstore.tags.TagOperationResource;
...
public class PetResourceTest extends AbstractAnnotationTest {
    ...
    private static final String PETSTORE_PACKAGE = "io.swagger.v3.jakartarest.petstore";
