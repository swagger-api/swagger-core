    ...
    public void apply(Project project) {
        ...
        config.defaultDependencies(new Action<DependencySet>() {
            public void execute(DependencySet dependencies) {
                ...
                dependencies.add(project.getDependencies().create("io.swagger.core.v3:swagger-jaxrs2:2.1.7-SNAPSHOT"));
                dependencies.add(project.getDependencies().create("jakarta.ws.rs:jakarta.ws.rs-api:2.1"));
