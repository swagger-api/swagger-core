...
public class Operation {
    ...
    public Operation merge(Operation op) {
        if (this.getConsumes() == null) {
            this.setConsumes(op.getConsumes());
        } else {
            if(op.getConsumes() != null) {
                this.getConsumes().addAll(op.getConsumes());
            }
        }
        ...
        if (this.getProduces() == null) {
            this.setProduces(op.getProduces());
        } else {
            if(op.getProduces() != null) {
                this.getProduces().addAll(op.getProduces());
            }
        }
            ...
            if(op.getResponses() != null) {
                for(String key: op.getResponses().keySet()) {
                    if(!responses.containsKey(key)) {
                        responses.put(key, op.getResponses().get(key));
                    }
                }
            }
        }
        ...
        if (this.getSchemes() == null){
            this.setSchemes(op.getSchemes());
        } else {
            if(op.getSchemes() != null) {
                this.getSchemes().addAll(op.getSchemes());
            }
        }
        ...
        if (this.getSecurity() == null){
            ...
            if(op.getSecurity() != null) {
                this.getSecurity().addAll(op.getSecurity());
            }
        }
        
        if (this.getSummary() == null){
            this.setSummary(op.getSummary());
        }
