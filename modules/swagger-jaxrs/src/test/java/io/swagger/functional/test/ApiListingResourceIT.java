...
/**
 * Created by rbolles on 2/16/16. <p> An functional integration test that runs during maven's
 * integration-test phase, uses RestAssured to define REST API tests, and Jetty's Maven plugin to
 * serve a simple sample app just prior to the integration-test phase starting.
 */
