...
public class SecurityScheme31Serializer extends JsonSerializer<SecurityScheme> {

    @Override
    public void serialize(SecurityScheme value, JsonGenerator jgen, SerializerProvider provider) throws IOException {
