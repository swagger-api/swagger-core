...
------------------------- | ------------ | -------------------------- | ----- | ----
1.5.3-SNAPSHOT (**develop**)                    |              | 2.0           | [master](https://github.com/swagger-api/swagger-core) | Under Development
1.5.2 (**stable**)                     | 2015-08-04   | 2.0           | [tag v1.5.2](https://github.com/swagger-api/swagger-core/tree/v1.5.2) | Supported
