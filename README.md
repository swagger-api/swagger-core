...
------------------------- | ------------ | -------------------------- | ----- | ----
2.2.5 (**current stable**)| 2022-11-02   | 3.0           | [tag v2.2.5](https://github.com/swagger-api/swagger-core/tree/v2.2.5) | Supported
...
### To build from source (currently 2.2.6-SNAPSHOT)
```
