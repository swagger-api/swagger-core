...
------------------------- | ------------ | -------------------------- | ----- | ----
2.1.11 (**current stable**)| 2021-09-29   | 3.0           | [tag v2.1.11](https://github.com/swagger-api/swagger-core/tree/v2.1.11) | Supported
...
2.1.4                     | 2020-07-25   | 3.0           | [tag v2.1.4](https://github.com/swagger-api/swagger-core/tree/v2.1.4) | Supported
...
1.6.3 (**current stable**)| 2021-09-29  | 2.0           | [tag v1.6.3](https://github.com/swagger-api/swagger-core/tree/v1.6.3) | Supported
...
### To build from source (currently 1.6.4-SNAPSHOT)
```
