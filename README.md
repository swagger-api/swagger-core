...
------------------------- | ------------ | -------------------------- | ----- | ----
1.5.4-M1-SNAPSHOT    | 2015-02-13  | 2.0           | [branch develop_2.0](https://github.com/swagger-api/swagger-core/tree/develop_2.0) |
...
### To build from source (currently 1.5.4-M1-SNAPSHOT)
```
