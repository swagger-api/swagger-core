...
------------------------- | ------------ | -------------------------- | ----- | ----
2.2.4 (**current stable**)| 2022-10-16   | 3.0           | [tag v2.2.4](https://github.com/swagger-api/swagger-core/tree/v2.2.4) | Supported
...
### To build from source (currently 2.2.5-SNAPSHOT)
```
