...
------------------------- | ------------ | -------------------------- | ----- | ----
2.2.44 (**current stable**)| 2026-03-03   | 3.x           | [tag v2.2.44](https://github.com/swagger-api/swagger-core/tree/v2.2.44) | Supported
...
### To build from source (currently 2.2.45-SNAPSHOT)
```
