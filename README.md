...
------------------------- | ------------ | -------------------------- | ----- | ----
2.2.1 (**current stable**)| 2022-06-15   | 3.0           | [tag v2.2.1](https://github.com/swagger-api/swagger-core/tree/v2.2.1) | Supported
...
### To build from source (currently 2.2.2-SNAPSHOT)
```
