...
------------------------- | ------------ | -------------------------- | ----- | ----
2.2.17 (**current stable**)| 2023-10-12   | 3.x           | [tag v2.2.17](https://github.com/swagger-api/swagger-core/tree/v2.2.17) | Supported
...
### To build from source (currently 2.2.18-SNAPSHOT)
```
