...
------------------------- | ------------ | -------------------------- | ----- | ----
2.2.18 (**current stable**)| 2023-10-25   | 3.x           | [tag v2.2.18](https://github.com/swagger-api/swagger-core/tree/v2.2.18) | Supported
...
### To build from source (currently 1.6.13-SNAPSHOT)
```
