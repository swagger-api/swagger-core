...
1.6.6 (**current stable**)| 2022-04-04   | 2.0           | [tag v1.6.6](https://github.com/swagger-api/swagger-core/tree/v1.6.6)                                            | Supported
...
### To build from source (currently 1.6.7-SNAPSHOT)
```
