...
------------------------- | ------------ | -------------------------- | ----- | ----
2.2.36 (**current stable**)| 2025-08-18   | 3.x           | [tag v2.2.36](https://github.com/swagger-api/swagger-core/tree/v2.2.36) | Supported
...
### To build from source (currently 2.2.37-SNAPSHOT)
```
