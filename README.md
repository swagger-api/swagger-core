...
------------------------- | ------------ | -------------------------- | ----- | ----
2.2.24 (**current stable**)| 2024-09-23   | 3.x           | [tag v2.2.24](https://github.com/swagger-api/swagger-core/tree/v2.2.24) | Supported
...
### To build from source (currently 2.2.25-SNAPSHOT)
```
