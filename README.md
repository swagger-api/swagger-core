...
------------------------- | ------------ | -------------------------- | ----- | ----
2.2.14 (**current stable**)| 2023-06-26   | 3.x           | [tag v2.2.14](https://github.com/swagger-api/swagger-core/tree/v2.2.14) | Supported
...
### To build from source (currently 2.2.15-SNAPSHOT)
```
