...
------------------------- | ------------ | -------------------------- | ----- | ----
2.2.19 (**current stable**)| 2023-11-10   | 3.x           | [tag v2.2.19](https://github.com/swagger-api/swagger-core/tree/v2.2.19) | Supported
...
### To build from source (currently 2.2.20-SNAPSHOT)
```
