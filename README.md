...
## Note!  This branch is deprecated!  Please see master for the latest.

[![Build Status](https://travis-ci.org/swagger-api/swagger-core.png?branch=scala-2.10)](https://travis-ci.org/swagger-api/swagger-core)
...
------------------------- | ------------ | -------------------------- | ----- | ----
1.3.13                     | 2014-11-27   | 1.2           | [tag v1.3.13](https://github.com/swagger-api/swagger-core/tree/v1.3.13)
...
### To build from source (currently 1.3.13)
```
