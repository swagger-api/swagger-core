...
------------------------- | ------------ | -------------------------- | ----- | ----
2.2.29 (**current stable**)| 2025-03-10   | 3.x           | [tag v2.2.29](https://github.com/swagger-api/swagger-core/tree/v2.2.29) | Supported
...
### To build from source (currently 2.2.30-SNAPSHOT)
```
